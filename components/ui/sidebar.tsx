  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 z-30 hidden w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex",
            "md:h-full",
            side === "left"
